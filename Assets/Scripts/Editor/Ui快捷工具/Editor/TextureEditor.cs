...
public class TextureEditor : MonoBehaviour
{
    ...
    //    }
    //}
    [MenuItem("Tools/UI快捷操作/将选择的图片转精灵 %#Z")]
    ...
    [MenuItem("Tools/UI快捷操作/将选择的图生成在Canvas上 %&SPACE")]
    ...
    [MenuItem("Tools/UI快捷操作/复制选中文件路径 %#X")]
    static void CopyPath()
    {
      ...
      //快捷键控制游戏对象的开关 alt + `
      [MenuItem("Tools/UI快捷操作/激活或失活游戏对象 &q")]
      ...
      //快捷键设置文本物体名字
      [MenuItem("Tools/UI快捷操作/快速将剪切板文字赋值给游戏对象和Text &w")]
